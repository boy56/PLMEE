...
extractor.add_argument('--use_loss_weight', type=bool, default=False)
...
extractor.add_argument('--do_train_trigger', type=bool, default=False)
extractor.add_argument('--do_train_argument', type=bool, default=False)

extractor.add_argument('--train_argument_with_generation', type=bool, default=False)
extractor.add_argument('--train_argument_only_with_generation', type=bool, default=False)
...
extractor.add_argument('--extractor_sorted', type=bool, default=False)
